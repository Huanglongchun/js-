...
// @description 脚本功能目前有：1--优酷、土豆、腾讯、芒果、爱奇艺、搜狐、乐视、PPTV、1905、华数、风行、西瓜视频...等各大视频网站，2--解决芒果TV在 uBlock Origin 或者 adguard 或者 ABP 过滤以后，会自动选择标清画质（出现这种情况，脚本会自动选择超清画质），3--解决官方普通视频首次播放部分浏览器默认静音问题（出现这种情况，脚本会自动打开声音），4--解决 某社区 在线视频不能全屏的问题，5--A站,B站,优酷,腾讯,爱奇艺,芒果TV,PPTV,搜狐,乐视视频关闭弹幕，6--豆瓣资源可以搜索观看视频，7--在猴子脚本站的搜索结果中添加评分，8--支持 网易云音乐、QQ音乐、酷狗、酷我、虾米、咪咕、5SING、喜马拉雅、全民K歌、一听音乐、echo回声、四季电台...等（非付费 和 非会员）音乐 和 MV 嗅探下载（先播放，然后点击网页右上角--猫咪按钮），9--电脑百度云支持倍速播放。（江小白无聊作品）
	...
	try {
		if (self != top) {
			...
			try {
				...
				function jxbvipobj() {
					var httpsjk, vipzdjx, vipjxtb, vipjxss, vipjxkjj, gbdmobj, jstgggobj, pdssgjcobj, mgzdgq, lkzdzt, zdbfqp, zdwbfobj, sjtzjx, jxbzdjxdsqobj;
					...
					const pcliwaiobj = obj.match(/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)|v\.qq\.com\/(?:x\/cover|variety\/p\/topic)\/|w(?:ww)?\.mgtv\.com\/(?:b|act)\/|www\.iqiyi\.com\/(?:[awv]_|kszt\/)|tw\.iqiyi\.com\/v_|tv\.sohu\.com\/v\/|film\.sohu\.com\/album\/|www\.le\.com\/ptv\/vplay\/|v\.pptv\.com\/show\/|vip\.1905\.com\/play\/|www\.wasu\.cn\/.+?\/show\/id\/|www\.bilibili\.com\/bangumi\/play\/|www\.fun\.tv\/vplay\/g-|www\.ixigua\.com\/\d{10,})/);
					const sjliwaiobj = obj.match(/^https?:\/\/(?:m\.youku\.com\/.+?\/id_|m\.mgtv\.com\/b\/|m\.pptv\.com\/show\/|vip\.1905\.com\/play\/|m\.tv\.sohu\.com\/(?:v|phone_play_film\?aid=)|m\.le\.com\/vplay_|m\.iqiyi\.com\/v_|www\.wasu\.cn\/.+?\/show\/id\/|(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)|m\.bilibili\.com\/bangumi\/play\/)/);
					...
					const jxjkobj = obj.match(/^https?:\/\/.+?(?:\.m(?:3u8|p4)\?\w+?=|(?:\w+?_\w+?|search|jx|url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?:\/\/[^\/]+?\.(?:youku|mgtv|sohu|pptv|wasu|1905|iqiyi|le|qq|bilibili|fun|ixigua)\.)/);
					...
					const mmkjjtjobj = obj.match(/^https?:\/\/(?:v\.qq\.com\/x\/page\/|www\.yinyuetai\.com\/play\?id=|(?:www\.)?zuidazy\d*?\.com\/\?m=vod-detail-id-)/);
					function h5zdbfobj() {
						(function() {
							function H5zdbfobj() {
								(function() {
					...
					if (iqiyialiwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj || mmkjjtjobj || objj.match(/(?:douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|zuidazy\d*?|(?:y|kg)\.qq|xiami|migu|ximalaya|app-echo|1ting|baidu)\./)) {
						...
						if (jxbpclwobj) {
							...
							cssobj('#江小白{position:relative!important;}div[class^="globallogin"]{z-index:2147483647!important;}[class^="pop-operates"],[id^="pop-operates"]');
							...
							cssobj('div[class="teleplay__playerContainer__wrapper"]{z-index:2147483647!important;}div.maomibtn a#jxbkjj,div[class="teleplayPage__interactionZone__LeftActions"],div[class="teleplay__LvideoRecomment"],a[href*="/www.ixigua.com/app/"]');
						...
						} else if (obj.match(/^https?:\/\/www\.bumimi.+?\/search\//)) {
							pdssgjcobj = 'ul#result>li>a';
							apddjobj();
							setTimeout(function() {
								try {
									if (document.querySelector("#result").innerText.match(/抱歉\s*?[,，]\s*?未找到相关视频/)) {
										top.location = window.location.href.replace(/^.+?\/search\/(.*)$/, "https://www.cupfox.com/search?key=$1");
									} else {}
								} catch (err) {}
							}, 1680);
							...
							lkzdztobj();
							h5zdbfobj();
						} else if (obj.match(/^https?:\/\/(?:yun|pan)\.baidu\.com\/(?:s|play)\//)) {
							jqjs();
							cssobj('img.btn-img-tips,[class="top-right-box"],[class="privilege-box"],span[node-type="app-user-vip-center"],a[class*="app-download"],span[class*="newIcon"],i[class*="-light-icon"],i[class^="bar-bling"],[class*="-functions-tips"],[node-type*="-info-container"],a[class*=" vipicon-"]');
							function bdyh5bfobj() {
								(function() {
									try {
										let m_bdybsbfxb = "<div href='javascript:void(0)' id='bdybsbox' style='color:red!important;cursor:pointer;z-index:98;display:block;width:100px;height:500px;line-height:30px;position:fixed;left:0;top:200px;text-size:15px;text-align:center;overflow:visible'> <style>a{font-size:16px;text-decoration:none;}a:hover {color:red;text-decoration:none}</style><a style='color:blue'>可选速度</a><br/><a id='bdybss1' style='color:black'>0.5倍</a><br/><a id='bdybss2' style='color:black'>0.75倍</a><br/><a id='bdybss3' style='color:black'>正常</a><br/><a id='bdybss4' style='color:black'>1.25倍</a><br/><a id='bdybss5' style='color:black'>1.5倍</a><br/><a id='bdybss6' style='color:black'>1.75倍</a><br/><a id='bdybss7' style='color:black'>2.0倍</a><br/><a id='bdybss8' style='color:black'>2.25倍</a><br/><a id='bdybss9' style='color:black'>2.5倍</a><br/><a id='bdybss10' style='color:black'>2.75倍</a><br/><a id='bdybss11' style='color:black'>3.0倍</a><br/><button id='bdybss12' style='color:black'> - 0.25 倍</button><br/><button id='bdybss13' style='color:black'> + 0.25 倍</button><br/><button id='bdybss14'style='color:black'>自动记忆</button><br/><br/><a style='color:blue'>当前速度</a><br/><a id='bdybsm_ts' style='color:red;font-size:16px;'></a></div>";
										$('body').append(m_bdybsbfxb);
										$('[id="bdybss1"]').click(speed1);
										$('[id="bdybss2"]').click(speed2);
										$('[id="bdybss3"]').click(speed3);
										$('[id="bdybss4"]').click(speed4);
										$('[id="bdybss5"]').click(speed5);
										$('[id="bdybss6"]').click(speed6);
										$('[id="bdybss7"]').click(speed7);
										$('[id="bdybss8"]').click(speed8);
										$('[id="bdybss9"]').click(speed9);
										$('[id="bdybss10"]').click(speed10);
										$('[id="bdybss11"]').click(speed11);
										$('[id="bdybss12"]').click(speed12);
										$('[id="bdybss13"]').click(speed13);
										$('[id="bdybss14"]').click(speed14);
										(function() {
											let bdybfobj_counter = 0;
											let bdybfobj_jiankong = setInterval(function() {
												let bdybfobj_btna = window.videojs.getPlayers("video-player").html5player;
												if (bdybfobj_btna) {
													try {
														if (localStorage.getItem("bdybszdyjobj") != '1') {
															try {
																localStorage.removeItem('bdtbsbfobj');
																localStorage.removeItem('bdybszdyjobj');
																localStorage.setItem('bdtbsbfobj', '1');
																document.getElementById("bdybsm_ts").innerHTML = localStorage.bdtbsbfobj + "倍数";
																window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
																document.querySelector('[id="bdybss14"]').innerHTML = "取消记忆"
															} catch (err) {}
														} else {
															if (localStorage.getItem("bdtbsbfobj") != null) {
																document.getElementById("bdybsm_ts").innerHTML = localStorage.bdtbsbfobj + "倍数";
																window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj)
															} else {
																localStorage.setItem('bdtbsbfobj', '1');
													...
													clearInterval(bdybfobj_jiankong);
													return false
												}++bdybfobj_counter;
												if (bdybfobj_counter > 100) {
													clearInterval(bdybfobj_jiankong);
													return false
												}
											}, 666)
										...
										function speedjxb() {
											(function() {
												try {
													if (localStorage.getItem("bdybszdyjobj") != '1') {
														if (!document.querySelector("jxbqzsxobj")) {
															document.head.appendChild(document.createElement("jxbqzsxobj"));
															try {
																let bdybsqsbtn = document.querySelector('div[class="video-content-list"] *');
																bdybsqsbtn.addEventListener('click', bdybsqsbtnClick, false);
																function bdybsqsbtnClick() {
																	location.reload();
																	bdybsqsbtn.removeEventListener('click', bdybsqsbtnClick, false)
																}
															} catch (err) {}
														} else {
															return false
										...
										function speed1() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '0.5');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "0.5倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed2() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '0.75');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "0.75倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed3() {
											try {
												...
												localStorage.setItem('bdtbsbfobj', '1');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "1.0倍速"
											} catch (err) {}
										}
										function speed4() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '1.25');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "1.25倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed5() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '1.50');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "1.5倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed6() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '1.75');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "1.75倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed7() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '2');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "2.0倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed8() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '2.25');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "2.25倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed9() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '2.50');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "2.50倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed10() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '2.75');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "2.75倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed11() {
											try {
												localStorage.removeItem('bdtbsbfobj');
												localStorage.setItem('bdtbsbfobj', '3');
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = "3.0倍速";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
													speedjxb()
												} else {}
											} catch (err) {}
										...
										function speed12() {
											try {
												if (localStorage.bdtbsbfobj) {
													if (localStorage.bdtbsbfobj == '0.25') {} else {
														localStorage.bdtbsbfobj = Number(localStorage.bdtbsbfobj) - 0.25
													}
												} else {
													localStorage.bdtbsbfobj = 1.0
												}
												window.videojs.getPlayers("video-player").html5player.tech_.setPlaybackRate(localStorage.bdtbsbfobj);
												document.getElementById("bdybsm_ts").innerHTML = localStorage.bdtbsbfobj + "倍数";
												if (localStorage.getItem("bdybszdyjobj") != '1') {
										...
										function speed14() {
											try {
												if (localStorage.getItem("bdybszdyjobj") != null) {
													localStorage.removeItem('bdybszdyjobj');
													document.querySelector('[id="bdybss14"]').innerHTML = "取消记忆"
												} else {
													localStorage.setItem('bdybszdyjobj', '1');
													document.querySelector('[id="bdybss14"]').innerHTML = "自动记忆"
												}
											} catch (err) {}
										}
									} catch (err) {}
							...
							if (obj.match(/^https?:\/\/(?:yun|pan)\.baidu\.com\/play\//)) {
								bdyh5bfobj();
							} else if (obj.match(/^https?:\/\/(?:yun|pan)\.baidu\.com\/s\//)) {
								(function() {
					...
					function jxbmmanzxobj() {
						if (objj.match(/(?:ximalaya|1ting|music)\./) && !objj.match(/music\.163\./)) {
							...
							if (objj.match(/music\.163\./)) {
								...
								btn.addEventListener('click', function() {
									...
									} else if (objj.match(/(?:kuwo|kugou|(?:y|kg)\.qq|xiami|migu|app-echo|radio\.sky31)\./)) {
										(function() {
											if (!document.querySelector("jxbyyxzjk")) {
												document.head.appendChild(document.createElement("jxbyyxzjk"));
												(function() {
							...
							(function() {
								...
								let mmyydsfzx_jiankong = setInterval(function() {
									...
									if (mmyydsfzx_btna) {
										if (document.querySelector('span[class="am-input-group-btn"]>a[id="j-src-btn"][target="_blank"][href^="http"]:not([href$="="])')) {
											top.location = document.querySelector('span[class="am-input-group-btn"]>a[id="j-src-btn"][target="_blank"][href^="http"]:not([href$="="])').href;
										} else {}
								...
								setTimeout(function() {
									if (jxbyyxzbobj == null || jxbyyxzbobj == undefined || jxbyyxzbobj == '') {
										...
										top.location = window.location.href.replace(/^.+?=(\d+?)&type=(.*)$/, jxbyyxzbobj + "$1&type=$2");
									} else {
										window.close()
									}
								}, 2345);
						...
						(function() {
							let aa = 1, bb = '<span><a1 style="display:none"></a1><a2 style="display:none">', cc = '<span><a1 style="color:darkgreen">搜索</a1><a2 style="display:none">', dd = '<span><a1 style="color:darkgreen">跳转</a1><a2 style="display:none">', ee = '<span><a1 style="color:darkgreen">小窗</a1><a2 style="display:none">', ff = '<span><a1 style="color:darkgreen">大窗</a1><a2 style="display:none">', ii = '<span style="background-color:hotpink"><a1 style="color:darkgreen"></a1><a2 style="display:none">', kk = '<span style="display:grid;background-color:aliceblue"><a1>自用</a1><a2 style="display:none">', jj = '<span style="background-color:darkorange"><a1 style="color:darkgreen"></a1><a2 style="display:none">', gg = '</a2><a3 style="color:#2196F3;zoom:0.8;font-weight:bold;">➽</a3><a4>', hh = '</a2><a3 style="display:none"></a3><a4>', https = [{
								...
								name: bb + aa+++hh + "零视",
								url: "https://video.eeeol.cn/jx.php?url="
							}, {
								name: bb + aa+++hh + "九八",
								...
								name: bb + aa+++hh + "147",
								url: "https://man.ledboke.com/147/?url="
							}, {
								name: bb + aa+++hh + "3jx",
								...
								name: dd + aa+++gg + "扶风",
								url: "https://v.591zhuiju.com/?url=",
								vip: "强制跳转"
							}, {
								name: dd + aa+++gg + "酷看",
								url: "https://jx.kukan.vip/jiexi/?url=",
								vip: "强制跳转"
							}, {
								name: dd + aa+++gg + "猪蹄",
                    ...
                    {"name":bb + aa+++hh +"纯净1","url":"https://z1.m1907.cn/?jx="},
                    {"name":bb + aa+++hh +"纯净2","url":"https://jx.618g.com/?url="},
                    {"name":bb + aa+++hh +"B站1","url":"https://vip.parwix.com:4433/player/?url="},
                    {"name":bb + aa+++hh +"B站2","url":"https://www.cuan.la/m3u8.php?url="},
                    {"name":bb + aa+++hh +"BL","url":"https://vip.bljiex.com/?v="},
                    {"name":bb + aa+++hh +"CK","url":"https://www.ckplayer.vip/jiexi/?url="},
                    {"name":bb + aa+++hh +"CHok","url":"https://www.gai4.com/?url="},
                    {"name":bb + aa+++hh +"大侠","url":"https://api.10dy.net/?url="},
                    {"name":bb + aa+++hh +"ELW","url":"https://jx.elwtc.com/vip/?url="},
                    {"name":bb + aa+++hh +"爱跟","url":"https://vip.2ktvb.com/player/?url="},
                    {"name":bb + aa+++hh +"冰豆","url":"https://api.qianqi.net/vip/?url="},
                    {"name":bb + aa+++hh +"百域","url":"https://jx.618g.com/?url="},
                    {"name":bb + aa+++hh +"ckmov","url":"https://www.ckmov.vip/api.php?url="},
                    {"name":bb + aa+++hh +"大幕","url":"https://jx.52damu.com/dmjx/jiexi.php?url="},
                    {"name":bb + aa+++hh +"迪奥","url":"https://123.1dior.cn/?url="},
                    {"name":bb + aa+++hh +"福星","url":"https://jx.popo520.cn/jiexi/?url="},
                    {"name":bb + aa+++hh +"跟剧","url":"https://www.5igen.com/dmplayer/player/?url="},
                    {"name":bb + aa+++hh +"RDHK","url":"https://jx.rdhk.net/?v="},
                    {"name":bb + aa+++hh +"H8","url":"https://www.h8jx.com/jiexi.php?url="},
                    {"name":bb + aa+++hh +"豪华","url":"https://api.lhh.la/vip/?url="},
                    {"name":bb + aa+++hh +"黑云","url":"https://jiexi.380k.com/?url="},
                    {"name":bb + aa+++hh +"蝴蝶","url":"https://api.hdworking.top/?url="},
                    {"name":bb + aa+++hh +"IK","url":"https://vip.ikjiexi.top/?url="},
                    {"name":bb + aa+++hh +"解析la","url":"https://api.jiexi.la/?url="},
                    {"name":bb + aa+++hh +"久播","url":"https://jx.jiubojx.com/vip.php?url="},
                    {"name":bb + aa+++hh +"九八","url":"https://jx.youyitv.com/?url="},
                    {"name":bb + aa+++hh +"老板","url":"https://vip.laobandq.com/jiexi.php?url="},
                    {"name":bb + aa+++hh +"乐喵","url":"https://jx.hao-zsj.cn/vip/?url="},
                    {"name":bb + aa+++hh +"M3U8","url":"https://jx.m3u8.tv/jiexi/?url="},
                    {"name":bb + aa+++hh +"MUTV","url":"https://jiexi.janan.net/jiexi/?url="},
                    {"name":bb + aa+++hh +"明日","url":"https://jx.yingxiangbao.cn/vip.php?url="},
                    {"name":bb + aa+++hh +"磨菇","url":"https://jx.wzslw.cn/?url="},
                    {"name":bb + aa+++hh +"诺诺","url":"https://www.ckmov.com/?url="},
                    {"name":bb + aa+++hh +"诺讯","url":"https://www.nxflv.com/?url="},
                    {"name":bb + aa+++hh +"OK","url":"https://okjx.cc/?url="},
				{"name":bb + aa+++hh +"PM","url":"https://www.playm3u8.cn/jiexi.php?url="},
                    {"name":bb + aa+++hh +"思云","url":"https://jx.ap2p.cn/?url="},
                    {"name":bb + aa+++hh +"思古","url":"https://api.sigujx.com/?url="},
                    {"name":bb + aa+++hh +"思古2","url":"https://api.bbbbbb.me/jx/?url="},
                    {"name":bb + aa+++hh +"思古3","url":"https://jsap.attakids.com/?url="},
                    {"name":bb + aa+++hh +"tv920","url":"https://api.tv920.com/vip/?url="},
                    {"name":bb + aa+++hh +"维多","url":"https://jx.ivito.cn/?url="},
                    {"name":bb + aa+++hh +"我爱","url":"https://vip.52jiexi.top/?url="},
                    {"name":bb + aa+++hh +"无名","url":"https://www.administratorw.com/video.php?url="},
                    {"name":bb + aa+++hh +"小蒋","url":"https://www.kpezp.cn/jlexi.php?url="},
                    {"name":bb + aa+++hh +"小狼","url":"https://jx.yaohuaxuan.com/?url="},
                    {"name":bb + aa+++hh +"智能","url":"https://vip.kurumit3.top/?v="},
                    {"name":bb + aa+++hh +"星驰","url":"https://vip.cjys.top/?url="},
                    {"name":bb + aa+++hh +"星空","url":"http://60jx.com/?url="},
                    {"name":bb + aa+++hh +"云端","url":"https://jx.ergan.top/?url="},
                    {"name":bb + aa+++hh +"云析","url":"https://jx.yparse.com/index.php?url="},
                    {"name":bb + aa+++hh +"17云","url":"https://www.1717yun.com/jx/ty.php?url="},
                    {"name":bb + aa+++hh +"33t","url":"https://www.33tn.cn/?url="},
                    {"name":bb + aa+++hh +"41","url":"https://jx.f41.cc/?url="},
                    {"name":bb + aa+++hh +"66","url":"https://api.3jx.top/vip/?url="},
                    {"name":bb + aa+++hh +"116","url":"https://jx.116kan.com/?url="},
                    {"name":bb + aa+++hh +"200","url":"https://vip.66parse.club/?url="},
                    {"name":bb + aa+++hh +"4080","url":"https://jx.urlkj.com/4080/?url="},
                    {"name":bb + aa+++hh +"973","url":"https://jx.973973.xyz/?url="},
                    {"name":bb + aa+++hh +"8090","url":"https://www.8090g.cn/?url="}
											...
											try {
												...
												try {
													if (jxbpcobj) {
														...
														if (objj.indexOf('youku') > 0) {
															...
															setTimeout(pcyjlwdszx, pczdydssjobj);
												...
												function vipobj(vip) {
													try {
														...
														} else if (objj.match('ixigua') || (pcliwaiobj && localStorage.getItem("jxywyfsgbobj") != null & !(sessionStorage.getItem("jxywygdfsgbobj") == '1'))) {
														...
														setTimeout(function() {
															if (document.querySelector(vip)) {
																if (jxb.match(new RegExp("^https:\/\/(?!.+?强制(?:弹[小大]窗|跳转))")) && !jxb.match(new RegExp("(?:最大网|布米米|米侠)"))) {
																	if (objj.match('ixigua') || (pcliwaiobj && localStorage.getItem("jxywyfsgbobj") != null & !(sessionStorage.getItem("jxywygdfsgbobj") == '1'))) {
																		if (objj.match('ixigua') || localStorage.getItem("jxywyfsgbobj") == '1') {
																			document.querySelector(vip).innerHTML = tctha;
																			window.open(jxb, "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=" + (screen.availWidth - screen.availWidth * 0.0075) + ",height=" + (screen.availHeight - 55));
																		...
																		document.querySelector(vip).innerHTML = '<div id="江小白" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"><iframe id="江小白" data-ad="false" autoLoad="true" autoplay="autoplay" loading="lazy" allowtransparency="true" frameborder="0" scrolling="no" sandbox="allow-scripts allow-same-origin allow-forms" allowCredentials="true" allowedHeaders="*" crossorigin="*" allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen" src="' + jxb + '" marginwidth="0" marginheight="0" width="100%" height="100%" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"></iframe></div>';
																	}
																	jxqzsxobj();
																} else {
																	function tcthbobj() {
																	...
																	if (jxb.match(new RegExp("最大网"))) {
																		...
																		if (jxb.match(new RegExp("^https?:\/\/.+?强制跳转"))) {
																			...
																			tcthbobj();
																			window.open(jxb.replace(/强制弹大窗.*?$/, ""), "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=" + (screen.availWidth - screen.availWidth * 0.0075) + ",height=" + (screen.availHeight - 55));
																			...
																			if (sessionStorage.getItem("jxyxkdfsgbobj") == '1') {
																				...
																				document.querySelector(vip).innerHTML = tctha;
																				window.open(jxb.replace(/强制弹小窗.*?$/, ""), "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=" + (screen.availWidth - screen.availWidth * 0.0075) + ",height=" + (screen.availHeight - 55));
							...
							if (jxbpcobj) {
								...
								function createMenuhttps() {
									...
									jxbhttps.onclick = function() {
										let httpsvipul = document.getElementById("httpsvipul"), jjxxkka = document.getElementById("jjxxkka");
										httpsvipul.setAttribute('tabindex', '1');
										let redHide = document.getElementById('httpsvipul');
										if (httpsvipul.style.display == "none") {
											try {
								...
								(function() {
									try {
										...
										let sjtzsjzdylwobj = /(?:爱跟|久已|蓝影|时光|大白|放开|冰豆|师兄|麻瓜)/, sjqjpbzdylwobj = /(?:无名|墨鱼)/, sjyyyzdypbobj = /(?:解啦|盘古|酷看|猪蹄|七彩|久播|九八|乐多|恶灵|吉塔|福星|枫林|大师|盖斯|CKP|M1907|H8|思[古云念]|蘑菇|OK|狼云|迪奥|618G|云端|大白|147|256|365|920|973|1717|4080|8090|星驰|月亮|黑云|小蒋|九八|金桥|诺讯)/i;
								...
								(function() {
									...
									function createSelectew(jxbhttpsew) {
										...
										document.body.insertAdjacentHTML('beforeend', '<style type="text/css">div[id^="jjxxkk"]{margin:0px;padding:0px;position:fixed;width:max-content;bottom:75px;left:50%;transform:translateX(-50%);z-index:102030;overflow:auto hidden;text-align:center;}div[id^="jjxxkk"]>span,div[id^="jjxxkk"]>a{float:left;border-radius:100%;color:white!important;box-shadow:inset transparent 0 0 0,transparent 0 0 0,black 2.5px 2.5px,blue 0 5px 0,transparent 0 0 0;background:0 0;font-weight:700;font-size:x-large;padding:10px 5px 10px 5px;border:2.5px outset buttonface;text-decoration:none;background-color:black;}</style><div id="jjxxkka" style="display:none;"><span id="sjzdws">最大网</span><span id="sjzdwss">茶杯狐</span></div>');
					...
					try {
						if (mgzdgq == 1 || mgzdgq == 2 || vipzdjx == 1 || vipzdjx == 2) {
							function panduanshebeiobj() {
								...
								if (jxbpcobj) {
									function jiangxiaobaiviphyzdpd() {
										if (!document.querySelector('div#江小白') && document.querySelector("jiangxiaobai")) {
											if ((mgzdgq == 1 || mgzdgq == 2 || vipzdjx == 2) && vipzdjx != 1) {
												try {
													if (obj.match(/^https?:\/\/v(?:-wb)?\.youku\.com\/v_show\/id_/)) {
														...
														if ((!document.querySelector('[class*="item"][class$=" current"]:not([tabindex])[tl]') && document.querySelector('[class*="item"][class$=" current"]:not([tabindex]) i[class="mark_v"]>img:not([alt])[src$=".png"]:not([src*="_only_"]):not([src*="_self_"]):not([src*="_full_"]):not([src*="_number_"]):not([src*=".png/"])[srcset$=".png 2x"]:not([srcset*="_only_"]):not([srcset*="_self_"]):not([srcset*="_full_"]):not([srcset*="_number_"]):not([srcset*=".png/"])')) || (document.querySelector('[class*="item"][class$=" current"]:not([tabindex])[tl] i[class="mark_v"]>img[alt][src$=".png"]:not([src*=".png/"])[srcset$=".png 2x"]:not([srcset*=".png/"])') && document.querySelector('[class*="item"][class$=" current"]:not([tabindex]) i[class="mark_v"]>img[src$=".png"]:not([src*="_only_"]):not([src*="_self_"]):not([src*="_full_"]):not([src*="_number_"]):not([src*=".png/"])[srcset$=".png 2x"]:not([srcset*="_only_"]):not([srcset*="_self_"]):not([srcset*="_full_"]):not([srcset*="_number_"]):not([srcset*=".png/"])')) || document.querySelector('[class*="item"][class$=" current"]:not([tabindex])[tl] i[class="mark_v"]>img:not([alt])[src$=".png"]:not([src*="_only_"]):not([src*="_self_"]):not([src*="_full_"]):not([src*="_number_"]):not([src*=".png/"])[srcset$=".png 2x"]:not([srcset*="_only_"]):not([srcset*="_self_"]):not([srcset*="_full_"]):not([srcset*="_number_"]):not([srcset*=".png/"])')) {
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
														...
														try {
															if ((mgzdgq == 1 || mgzdgq == 2) && document.querySelector(".m-player-h5-new .u-control-clarity .btn") && document.querySelector(".m-player-h5-new .u-control-clarity .btn").innerText.match(/^\s*?自动/) && vipzdjx != 1) {
																if (mgzdgq == 1) {
																	if (document.querySelector('a[data-name="超清"][data-purview="true"]')) {
																		document.querySelector('a[data-name="超清"][data-purview="true"]').click();
																		log("%c江小白-电脑-芒果自动选择超清-00-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																		...
																		log("%c江小白-电脑-芒果自动选择高清-00-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																	} else {}
																} else if (mgzdgq == 2) {
																	if (document.querySelector('a[data-name="高清"][data-purview="true"]')) {
																		document.querySelector('a[data-name="高清"][data-purview="true"]').click();
																		log("%c江小白-电脑-芒果自动选择高清-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																	} else {}
																}
															} else {}
														} catch (err) {}
														if (vipzdjx == 2 && obj.match(/^https?:\/\/(?:ww)?w\.mgtv\.com\/b\//) && document.querySelector("jiangxiaobai")) {
														...
														if (document.querySelector('ul>li[class*="item"][class$=" selected"] img[src*="/vip"][src$=".png"]:not([src*=".png/"])[srcset*="/vip"][srcset*=".png"]:not([srcset*=".png/"])') || document.querySelector('ul>li[class*="item"][class$=" selected"] img[src*="/VIP"][src$=".png"]:not([src*=".png/"])[srcset*="/VIP"][srcset*=".png"]:not([srcset*=".png/"])')) {
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
														...
														if ($('[class*="buyGuidance"]:contains("费"):contains("看")')[0]) {
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
					...
					try {
						if (jxbpcobj && (pcliwaiobj || ttbkjjliobj || mmkjjtjobj || objj.match('(?:bilibili|acfun)'))) {
							try {
								function ywyjklb() {
									if (pcliwaiobj) {
										(function() {
								...
								function ckjxbkjj() {
									if ((!ttbkjjliobj && !objj.match('zuidazy') || objj.match('(?:bilibili|acfun)'))) {
										(function() {
											try {
								...
								function sddj() {
									if (pcliwaiobj || ttbkjjliobj || objj.match('zuidazy') && localStorage.getItem("zdwbfobj") == '1') {
										if (pcliwaiobj) {
											(function() {
												try {
										...
										} else if (objj.match('zuidazy')) {
											try {
												if (document.querySelector("#jiangxiaobai").parentElement.nextElementSibling.innerText.match(/\.m3u8/i)) {
													document.querySelector("#jiangxiaobai>iframe").src = document.querySelector("#jiangxiaobai>iframe").src.replace(/^(http.+?=)http.+$/, "$1") + document.querySelector("#jiangxiaobai").parentElement.nextElementSibling.innerText.replace(/^.+\$(.+)$/, "$1");
												} else {
													document.querySelector("#jiangxiaobai>iframe").src = document.querySelector("#jiangxiaobai").parentElement.nextElementSibling.innerText.replace(/^.+\$(.+)$/, "$1");
												}
												document.querySelector("#jiangxiaobai>div>div:nth-child(6)>h1:nth-child(2)").innerText = document.querySelector("#jiangxiaobai").parentElement.nextElementSibling.innerText.replace(/^(.+)\$.*$/, "$1");
												document.querySelector("#jiangxiaobai").parentElement.nextElementSibling.remove();
											} catch (err) {}
										} else if (ttbkjjliobj) {
											(function() {
												try {
									...
									if (pcliwaiobj && !objj.match('ixigua\.')) {
										(function() {
											try {
												...
												localStorage.setItem("httpsjk", createRandom2(1, document.querySelectorAll("ul#httpsvipul>li").length - 22, document.querySelectorAll("ul#httpsvipul>li").length - 1));
												setTimeout(function() {
													try {
														$("ul#httpsvipul>li>span").css("backgroundImage", "");
														document.querySelector("ul#httpsvipul>li:nth-child(" + localStorage.getItem("httpsjk") + ")>span").style.backgroundImage = "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=)";
									...
									if (pcliwaiobj && !objj.match('ixigua\.')) {
										(function() {
											try {
												...
												localStorage.setItem("httpsjk", createRandom2(1, 3, document.querySelectorAll("ul#httpsvipul>li").length - 22));
												setTimeout(function() {
													try {
														$("ul#httpsvipul>li>span").css("backgroundImage", "");
														document.querySelector("ul#httpsvipul>li:nth-child(" + localStorage.getItem("httpsjk") + ")>span").style.backgroundImage = "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=)";
					...
					if (obj.match(/^https?:\/\/(?!.+?\?m=vod-detail-id-)(?:www\.)?zuidazy/)) {
						...
						setTimeout(function() {
							...
							if ($("div.xing_vb>ul>li>span>a").length == 1) {
								...
								try {
									if (document.querySelector("div.container>div>dl>dd").innerText.match(/共\s*?0\s*?条/)) {
										if (jxbpcobj) {
											top.location = window.location.href.replace(/^.+?=vod-search&wd=(.*)$/, "http://www.bumimi99.com/search/$1");
										} else {
											top.location = window.location.href.replace(/^.+?=vod-search&wd=(.*)$/, "https://www.cupfox.com/search?key=$1");
										}
									} else {}
								} catch (err) {}
							}
						...
						jqjs();
						cssobj('li#zdwbfobjli{display:block!important;}div.maomibtn a#jxbkjj');
								...
								if (self != top) {} else {
									...
									function zuidam3u8() {
										try {
											...
											remove('body>div.warp>div:nth-child(4)>div,#play_1>h3,#play_1 input,div#copyContent,div[style="clear:both"]');
											document.onclick = function(e) {
												if (!document.querySelector("#play_1>ul>li:first-child").innerText.match(/\.m3u8$/i)) {
													const linka = /^([^$]+?)\$\s*?(https?:\/\/[^\/]+?\/share\/\w+)$/i;
													if (!e.target.innerHTML.match(/<jiangxiaobai /) && !e.target.innerHTML.match(/<iframe /) && e.target.innerText.match(linka)) {
						...
						cssobj('script+p,img,[class$="search-other-names"],div>[style^="z-index:"],[class*="block"],[class$="movie border-shadow"],[class*="sidebar"],ul[class$="fixed-nav"],div[class$=" nav"]>span:not([class*="title"]):not([class*="xuanpian"]):not([class*="bangdan"]),img[width*="%"],[class$="movie border-shadow"]+[style^="z-index:"],[class$="title-wrapper"]~[class$="mobile-detail-block"],[class$="fixed-nav"]+[class$="movie border-shadow"],[class$="mobile-container"]+[class$="mobile-nav"],[class$="card border-shadow"],[class*="burger-button"],[id^="page-wrap"]>[style^="z-index:"],[id^="hjuj"]');
					} else {}
				};
			} catch (err) {
				return false;
